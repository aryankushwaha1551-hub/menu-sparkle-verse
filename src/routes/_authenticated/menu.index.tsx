    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-2xl p-4 grid gap-3 md:grid-cols-4">
        ...
        <select
          ...
          className="h-10 rounded-md bg-input border border-border px-3 text-sm"
        >
      ...
      {loading ? (
        ...
        <div className="glass rounded-2xl p-14 text-center">
          ...
          <Link to="/menu/new">
            <Button className="mt-6 bg-primary text-primary-foreground gold-glow rounded-xl">
              Add Your First Dish
            </Button>
          </Link>
        </div>
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                {d.categories && (
                  <div className="mt-2 text-xs text-muted-foreground">
                    {d.categories.emoji} {d.categories.name}
                  </div>
                )}
                <div className="mt-4 flex gap-2 pt-4 border-t border-border/40">
                  ...
                  <Link to="/qr-codes">
                    <Button variant="outline" size="sm" className="rounded-lg border-primary/30">
